...
export function DenseGroupBlock({
  ...
  if (!expanded) {
    ...
    const highCount = groupNodes.filter((n) => n.significance === "high").length;

    return (
      <div
        id={groupNodes[0].id}
        className="mb-6 flex cursor-pointer items-start rounded-lg transition-colors hover:bg-chrono-surface/50"
