...
Requires:
    ...
    - OPENROUTER_API_KEY (or relevant provider keys) configured in .env
...
# Model A: current default (Kimi K2 via OpenRouter)
MODEL_A_NAME = settings.dedup_model
# Model B: candidate replacement
MODEL_B_NAME = "openrouter:deepseek/deepseek-chat"
